...
import { selectLoadPost } from '../store/user/user.selector';
...
const getMimeType = (extension) => {
  ...
  if (hasPermission === false) {
    ...
    <View style={{flex:1,justifyContent:'center',alignItems:'center',backgroundColor:Color.BLACK_BACKGROUND}}>
          <Text style={{fontSize:18,fontWeight:'bold',color:Color.WHITE}}>No access to media library</Text>
    ...
    <View  style={{flex:1,backgroundColor:Color.BLACK_BACKGROUND}}>
        <SafeAreaView style={{flex:1}}>
          ...
          <View>
                ...
                <Text style={{color:Color.WHITE,fontSize:16,fontWeight:'bold'}}>New post</Text>
              ...
              <View style={{
                ...
                <TouchableOpacity>
                    <View style={styles.pickerIconContainer}>
                        ...
                        <Feather name="chevron-down" size={24} color={Color.WHITE} />
                    </View> 
                </TouchableOpacity>
