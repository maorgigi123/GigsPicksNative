...
import { selectCurrentUser, selectLoadPost } from '../store/user/user.selector';
    ...
    navigation.navigate('FeedMain');
        ...
        try {
            if (ws.currentWs && ws.currentWs.readyState === WebSocket.OPEN) 
                ws.currentWs.send(JSON.stringify({type:'UploadPost', payload:{userId:user._id,username: user.username,content: caption,
    ...
    return (
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <KeyboardAvoidingView
                ...
                style={{ flex: 1, backgroundColor: Color.BLACK_BACKGROUND }}
            >
                     <View style={{ flex: 1 }}>
                    ...
                    <View style={styles.tagContainer}>
                        <Text style={{ color: Color.WHITE }}>Tags:</Text>
...
const styles = StyleSheet.create({
    ...
    TextInputContainer: {
        ...
        position: 'relative',
        borderWidth: 1,
        borderColor: Color.BLACK_BACKGROUND,
