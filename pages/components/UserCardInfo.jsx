  ...
  return (
    <View style={styles.cardContainer}>
        <View style={{display:'flex',flexDirection:'row',height:'100%',width:'100%',backgroundColor:Color.PRIMARY_BUTTON,borderRadius:20}}>
            <ExpoImage source={{uri:`${process.env.EXPO_PUBLIC_API_URL}/uploads/${user.profile_img}`}} style={{height:'100%',width:100,borderTopLeftRadius:20,borderBottomLeftRadius:20,objectFit:'cover',backgroundColor:'transparent'}}/>
